...
module.exports = (sequelize) => {
  const givenEnergies = sequelize.define(
    "givenEnergies",
    {
      id: {
      ...
      id_equipment: {
        ...
        foreignKey: true,
        references: {
          model: "energy_equipments", // name of Target model
          key: "id_equipment", // key in Target model that we're referencing
        },
        allowNull: false,
        validate: {
          isInt: {
